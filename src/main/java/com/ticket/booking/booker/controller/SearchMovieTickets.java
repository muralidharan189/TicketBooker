...
@Controller
public class SearchMovieTickets {
	@RequestMapping(value="/SMT", method=RequestMethod.GET)
	public ModelAndView listMovieDetails(HttpServletRequest request, HttpServletResponse response){
		ModelAndView mav = new ModelAndView("listmovie");
		mav.addObject("Movie", new Train());
		return mav;
